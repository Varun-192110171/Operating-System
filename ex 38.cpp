...
int main() {
    ...
    // Moving the head in the reverse direction
    total_distance += current_pos;
    printf("Moving the head to the beginning.\n");
    current_pos = 0;
    total_distance += max_cylinder;
    printf("Moving the head to the end.\n");

    // Servicing remaining requests on the way back
